...
@interface OfficialScanQRCodeView ()<AVCaptureMetadataOutputObjectsDelegate, UIImagePickerControllerDelegate, UINavigationControllerDelegate>
...
@implementation OfficialScanQRCodeView
...
- (void)initDatas
{
    ...
    CGFloat scanY = scanX;
    self.metadataOutput.rectOfInterest = CGRectMake((scanY + 64)/Screen_Height, scanX/Screen_Width, ScanW/Screen_Height, ScanW/Screen_Width);
